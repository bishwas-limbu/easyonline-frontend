...
const ShopContextProvider = ({ children }) => {
    ...
    const cartCount = () => {
        let countTotal = 0;
        console.log("cart count",cartProducts)
    ...
    const value = useMemo(() => ({
        ...
        navigate,
        setCartProducts,
        backend_url,token,setToken,currentState, setCurrentState
    }), [setCartProducts,token,setToken,products, currency, delivery_fee, search, showSearch, cartProducts, addToCart, updateCartQuantity, totalCartAmount, navigate, backend_url,currentState, setCurrentState]);
